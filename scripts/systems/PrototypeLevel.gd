...
## per Catmull-Rom-Handles gesetzt statt scharfer 90-Grad-Ecken. Vor dem
## ersten und nach dem letzten sichtbaren Punkt haengen zwei gerade
## Off-Screen-Segmente (300 Einheiten, >= 150 gefordert), damit Gegner nicht
## sichtbar im Feld auftauchen/verschwinden.
func _build_path() -> void:
	var curve := Curve2D.new()
	curve.add_point(Vector2(-300, 540), Vector2.ZERO, Vector2(140, 0))
	curve.add_point(Vector2(70, 540), Vector2(-140, 0), Vector2(140, 0))
	...
	curve.add_point(Vector2(1850, 850), Vector2(-140, 0), Vector2(140, 0))
	curve.add_point(Vector2(2220, 850), Vector2(-140, 0), Vector2.ZERO)
